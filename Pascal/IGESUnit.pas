...
type TIgesString = string[80];
     TIGESList = class
        private
           ...
           FNoSurfaces: Integer;
           FIGESunits       : TUnitType;
           FMaxCoordinate   : Real;
           FSystemID,
           FFileCreatedBy   : TIgesString;
           FFileName        : String;
           procedure FProcessParameterData(Str:String;ParamData:TStringList);
        public
           procedure Add_Entity_128(NURB:TNURBSurface;ColorIndex:Integer);
//         function  Add_Entity_314(Color:TColor):Integer; -- надо разбираться!
           procedure Clear;
           constructor Create;
           destructor Destroy; override;
           procedure SaveToFile(Filename:String);
           property FileCreatedBy  : TIgesString read FFileCreatedBy write FFileCreatedBy;
           property FileName       : String read FFileName write FFileName;
           property IGESUnits      : TUnitType read FIGESunits write FIGESunits;
           property SystemID       : TIgesString read FSystemID write FSystemID;
     end;
...
begin
   L:=Length(Str);
   if L>Maxlength then Str:=Copy(Str,1,MaxLength) else
...
procedure TIGESList.FProcessParameterData(Str:String;ParamData:TStringList);
...
procedure TIGESList.Add_Entity_128
( NURB:TNURBSurface; ColorIndex:Integer );
...
(*
function TIGESList.Add_Entity_314( Color:TColor ):Integer;
...
procedure TIGESList.SaveToFile(Filename:String);
