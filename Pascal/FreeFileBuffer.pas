...
procedure TFreeTextBuffer.Add( FloatValue: TFloatType ); var S: String;
...
{
procedure TFreeTextBuffer.LoadTColor( var Output: TColor ); var S: String;
    begin S:=FLines[FPosition];
