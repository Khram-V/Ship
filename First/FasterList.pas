...
procedure TFasterList.Sort;
   ...
   begin I:=L; J:=R; Val:=Cardinal(FList[(L+R) div 2]);
      repeat
...
var MemAddr,MidVal: Cardinal; L,H,Mid: Integer;
begin
   Result:=-1; MemAddr:=Cardinal( Item ); L:=0; H:=FCount-1;
   while L<=H do begin
      Mid:=(L+H) div 2;
