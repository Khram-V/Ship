...
var I,Index: Integer; Layer: TFreeSubdivisionLayer;
begin
         ...
         if Point.NumberOfFaces>0 then begin
            if Checkbox.Checked then begin
              ...
              for J:=1 to Point.NumberOfFaces do begin
                ...
                if Layerbox.Checked[ind] then begin Select:=True; break; end;
              end;
            end else begin
              ...
              for J:=1 to Point.NumberOfFaces do begin
                ...
                Layer:=Face.Layer;
                Ind:=LayerBox.Items.IndexOfObject(Layer);
                if not Layerbox.Checked[ind] then begin Select:=false; break; end;
              end;
            end;
...
begin
   for I:=0 to NumberOfLayers-1 do if Selected[I] then begin Layer:=self.Layer[I];
      Destination.Capacity:=Destination.Count+Layer.Count;
      for J:=0 to Layer.Count-1 do Destination.Add(Layer.Items[J]);
   end;
end;
