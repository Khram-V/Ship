...
procedure TMainForm.FormShow( Sender: TObject ); Var NF: AnsiString='';
...
begin
   Panel3.Caption:=Userstring(284)+': '+Truncate(Ship.Visibility.CursorIncrement,5);
end;
...
begin
   ...
   Str:=Truncate( Ship.Visibility.CursorIncrement,5 );
