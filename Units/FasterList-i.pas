...
begin
  if (Index<0) or (Index >= FCount) then WriteLn('Index out of bounds');
  Dec(FCount);
...
begin
  if (index<0) or (Index >= FCount) then WriteLn('Index out of bounds');
  if FUnique and (self.IndexOf(Item)>=0) then begin WriteLn('Uniqueness violation'); exit; end;
...
begin
  if (Index<0) or (Index>=FCount) then WriteLn('Index out of bounds');
  if FUnique and (IndexOf(Item)>=0) then WriteLn('Uniqueness violation');
  FList[Index] := Item;
...
finalization
  WriteLn('FasterList Stat_SortedIndexOf_calls: '+inttostr(FStat_SortedIndexOf_calls));
  WriteLn('FasterList Stat_SortedIndexOf_loops: '+inttostr(FStat_SortedIndexOf_loops));
  WriteLn('FasterList Stat_SortedIndexOf_items: '+inttostr(FStat_SortedIndexOf_items));
  WriteLn('FasterList Stat_IndexOf_calls: '+inttostr(FStat_IndexOf_calls));
  WriteLn('FasterList Stat_IndexOf_loops: '+inttostr(FStat_IndexOf_loops));
  WriteLn('FasterList Stat_IndexOf_items: '+inttostr(FStat_IndexOf_items));
end.
