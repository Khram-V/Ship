...
//  procedure LoadControlPointNames( Source:TFreeFileBuffer );    // fv421
...
//  procedure SaveControlPointNames(Destination:TFreeFileBuffer);  // fv421
...
//  procedure SaveControlPointGroups(Destination:TFreeFileBuffer);  // fv430
